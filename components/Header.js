        ...
        {isMenuOpen && (
            <div className="md:hidden bg-background-dark/90">
                <nav className="container mx-auto flex flex-col items-start gap-4 px-4 py-4 sm:px-6 lg:px-8">
                    ...
                    <NavLink href="/contact">Contact</NavLink>
                     <SignedOut>
                        <a className="w-full mt-2 rounded-lg bg-white px-4 py-2 text-sm font-bold text-center text-black transition-opacity hover:opacity-90" href="/sign-in">Sign In</a>
                    </SignedOut>
                </nav>
            </div>
        )}
