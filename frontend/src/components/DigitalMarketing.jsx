...
const DigitalMarketing = () => (
    <section className={`flex md:flex-row flex-col ${styles.paddingY} bg-white dark:bg-transparent`}>
        <div className={`flex-1 flex flex-col items-center md:items-start text-center md:text-left`}>
            <h2 className="font-poppins font-light text-[40px] md:text-[60px] leading-[40px] md:leading-[60px] text-lightText dark:text-white">
                All In One
            </h2>
            <h1 className="font-poppins font-black text-[60px] md:text-[100px] leading-[60px] md:leading-[90px] text-lightText dark:text-white tracking-tighter">
                DIGITAL
            </h1>
            <h1 className="font-poppins font-black text-[60px] md:text-[100px] leading-[60px] md:leading-[90px] text-lightText dark:text-white tracking-tighter">
                MARKETING
        ...
        <div className={`flex-1 flex flex-col justify-center items-center md:items-start md:ml-10 ml-0 md:mt-0 mt-10 text-center md:text-justify`}>
            <p className="font-poppins font-normal text-[14px] md:text-[16px] leading-[24px] md:leading-[28px] text-lightDimText dark:text-dimWhite mb-6">
            ...
            <p className="font-poppins font-normal text-[14px] md:text-[16px] leading-[24px] md:leading-[28px] text-lightDimText dark:text-dimWhite">
