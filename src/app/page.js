          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mt-16 grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <ServiceCard 
                ...
                description="A successful product is more than just code—it's an experience. We craft compelling brand identities and intuitive, user-friendly interfaces that drive engagement."
              />
              <ServiceCard 
                icon={<FaRocket />}
