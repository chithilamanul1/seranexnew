...
import { SiNextdotjs, SiVercel, SiFirebase, SiTailwindcss, SiGithub, SiLinkedin, SiTwitter } from 'react-icons/si';
    ...
    <>
      ...
      <div className="w-full">
        ...
        <section className="min-h-screen flex flex-col justify-center items-center text-center px-6 pt-20">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-8 text-gray-300 animate-fade-in-up [animation-delay:0.2s]">
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="mt-4 flex space-x-4">
            {/* --- THIS IS THE FIX for Link Names --- */}
            <a href="#" aria-label="Visit our Twitter profile" className="text-gray-400 hover:text-blue-500 transition-colors"><FaTwitter size={20} /></a>
            <a href="#" aria-label="Visit our LinkedIn profile" className="text-gray-400 hover:text-blue-500 transition-colors"><FaLinkedin size={20} /></a>
            <a href="#" aria-label="Visit our GitHub profile" className="text-gray-400 hover:text-blue-500 transition-colors"><FaGithub size={20} /></a>
            {/* --- END OF FIX --- */}
          </div>
        </div>
      </div>
      <div className="border-t border-gray-800 pt-8 mt-16 text-center text-gray-400 text-sm">
        {/* --- THIS IS THE FIX for Contrast --- */}
