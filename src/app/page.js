      ...
      <section ref={portfolioRef} className="container mx-auto px-6 py-16 sm:py-24 fade-in-section">
        <div className="w-full max-w-6xl mx-auto">
          ...
          <div className="text-center mt-12">
            <Link href="/portfolio" className="font-semibold text-theme-blue hover:underline">
        ...
        <div className="container mx-auto px-6 py-24">
          <div className="relative isolate overflow-hidden bg-black/20 border border-white/10 px-6 py-24 text-center shadow-2xl rounded-2xl sm:px-16">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <Link
                href="/contact"
                className="rounded-md bg-white px-5 py-2.5 text-sm font-semibold text-black shadow-sm hover:bg-gray-200 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
                Get a Quote
              </Link>
